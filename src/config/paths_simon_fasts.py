"""
Configuration file for Simon dataset
"""
...
# Registration paths
PROCESSED_FILES_DIR = Path('/mnt/d/data/fastserfer_simon')
REGISTERED_FILES_DIR = Path('/mnt/d/data/registration/simon_fasts_ses1')
